...
<head>
  ...
  <title>MES Express | Merchant</title>
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-warning">
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="/merchant" class="nav-link">Home</a>
          </li>
          <li class="nav-item">
            <a href="/mprofile" class="nav-link">Profile</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="/merchant/create" class="dropdown-item">Add New Parcel</a></li>
              <li><a href="/merchant_parcels" class="dropdown-item">All Parcels</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
